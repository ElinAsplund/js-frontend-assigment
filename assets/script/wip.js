...
const isNameValid = name => {
    // Regual expression, checking if name has any numbers in it. 
            ...
            switch (element.type) {
                ...
                case 'text':
                    ...
                    if (!isNullOrEmpty(element.value)) {
                        ...
                        // if-sats: finns det några nummer i namnet?
                        if (!isNameValid(element.value)) {
                            error += ` Your ${label.toLocaleLowerCase()} can't contain numbers.`
                            console.log(error);
                        } else {
                            console.log("Success!");
                        }
